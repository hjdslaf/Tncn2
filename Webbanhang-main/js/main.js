...
function detailProduct(index) {
    ...
    <div class="modal-body">
        ...
        <p class="product-description" style="font-weight: bold; font-size: 15px;">Địa chỉ :   ${infoProduct.desc}</p>
    ...
    <div class="modal-footer">
        ...
        <div class="modal-footer-control">
            <button class="button-dat" id="add-cart" onclick="animationCart()"><i class="fa-regular fa-heart"></i></button>
        </div>
    </div>`;
...
function changeInformation() {
    ...
    if (infoname.length < 3) {
        document.querySelector('.infoname-error').innerHTML = 'Vui lòng nhập họ và tên lớn hơn 3 kí tự';
        return;
    } else {
        document.querySelector('.infoname-error').innerHTML = '';
    }
                    ...
                    <div class="food-info">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="product-buy">
                                <button onclick="detailProduct(${product.id})" class="card-button order-item"><i class="fa-regular fa-heart"></i> Yêu thích</button>
                            </div>
                            <div class="product-rating">
                                <!-- Đổi tên lớp ngôi sao thành 'rating-star' -->
                                <a href="rating-page.html?product=${product.id}" class="rating-link">
